...
To use the --repl option, get Chj::repl from
https://github.com/pflanze/chj-perllib (ask me for a primer in how to
use it or to finally fix it when not using :l or :d).
