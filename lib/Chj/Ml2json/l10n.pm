...
our $translations=
  +{
    ...
    "plain"=> {en=> "Plain Text", de=> "Unformattiert"},
    "rich"=> {en=> "Rich Text", de=> "Rich Text"},
    "Image"=> {de=> "Bild"},
    "click to open"=> {de=> "klicken zum Öffnen"},
    "Generated by "=> {de=> "Generiert mit "},
    "show raw source code of this mail"=>
    {de=> "rohen Quelltext dieser Nachricht anzeigen"},
    "show X segment that has been sent with this mail"
    => {
	en=> sub {
	    my ($kind)=@_;
	    my $lkind= __"X $kind";
	    "show $lkind segment that has been sent with this mail"
	},
	de=> sub {
	    my ($kind)=@_;
	    my $lkind= __"X $kind";
	    "$lkind Segment das mit dieser Nachricht geschickt wurde anzeigen"
	},
       },
    "X plain"=> {en=> "plain text", de=> "unformattiertes (plain text)"},
    "X rich"=> {en=> "Rich Text formatted", de=> "Rich Text-formattiertes"},
    "X html"=> {en=> "HTML formatted", de=> "HTML-formattiertes"},
   };
